...
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../main */ "./src/js/main.js");
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        setTimeout(function () {
          document.querySelector('#form__end').style.display = "none";
          document.body.style.overflow = "";
        }, 2000);
        setTimeout(function () {
          for (var prop in _main__WEBPACK_IMPORTED_MODULE_6__["modalState"]) {
            delete _main__WEBPACK_IMPORTED_MODULE_6__["modalState"][prop];
          }
        }, 5000);
      });
    });
...
var modals = function modals() {
  ...
  } // избавляемся от дерганий при открытии модалки 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(elem, deadline) {
  ...
  }; // Добавить ноль если число однозначное
